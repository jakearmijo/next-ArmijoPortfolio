      ...
      <div id="aboutMe">
        ...
        <div id="aboutMeMain">
          ...
          <p
            data-aos="fade-up"
            id="pIntro"
            className="aos-init aos-animate p-project"
          >
            [ Hello, World, ! ] I am a sociable creator with adoration for
            variety. As a kid, I lived frequently singing and playing with Legos
            or Erector sets. As an adult, I helped build commercial buildings,
            and now I help build software solutions. All while still singing. I
            have a swiss army knife-like mindset and love to learn new things. I
            am a versatile team player with a vivid imagination. My off-hours
            creative activities include fly tying, djing, and making my family
            laugh. I am always willing to chat. Feel free to message me! Career
            switcher 2020 - Girl Dad - Fly Fisher
          </p>
        </div>
      </div>
      <div id="skillsDiv">
